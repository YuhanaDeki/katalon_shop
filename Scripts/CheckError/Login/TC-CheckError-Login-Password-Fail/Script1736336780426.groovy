...
WebUI.setText(findTestObject('Login/Admin/Input_Username'), GlobalVariable.ck_username_true)

WebUI.setText(findTestObject('Login/Admin/Input_Password'), GlobalVariable.ck_password_error)
