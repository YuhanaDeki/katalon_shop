...
WebUI.setText(findTestObject('Login/Admin/Input_Username'), GlobalVariable.officer_username)

WebUI.setText(findTestObject('Login/Admin/Input_Password'), GlobalVariable.officer_password)
