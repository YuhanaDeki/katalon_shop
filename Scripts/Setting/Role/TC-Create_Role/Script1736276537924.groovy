...
WebUI.setText(findTestObject('Setting/Role/Create/Create_01/Input_Role_Name'), GlobalVariable.role_name)
...
WebUI.setText(findTestObject('Setting/Role/Create/Create_01/Input_Search'), GlobalVariable.role_name)

WebUI.verifyElementText(findTestObject('Setting/Role/Create/Create_01/Verifty_Text'), GlobalVariable.role_name)
